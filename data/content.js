// Sab image URLs original WordPress site (knowles.uk.com) se hain.
// next.config.js mein "knowles.uk.com" ko remotePatterns mein allow kiya gaya hai.
...
export const introBlocks = [
  {
    ...
    paragraphs: [
      "We have extensive experience working on a broad range of private residential projects, both historic and contemporary, with a project portfolio including London townhouses and villas, restoring listed country homes, and the creation of major new private residences and country estates. We offer specialist skills in construction, structural and heritage projects, with our in-house Structures division handling all shell, core and subterranean works.",
      "Knowles is a family-run construction business, founded by Robin Knowles. Our headquarters in Marylebone, London coordinates our 250 strong workforce, across London and the Home Counties, with all members of the Knowles team sharing our commitment to delivering a service for our clients that is like no other.",
    ],
  },
  {
    ...
    paragraphs: [
      "Our commitment to in-house management guarantees a consistent approach and the best experience for our clients; from the management of structural design, to the coordination of all consultant and subcontractor packages. As Principal Contractor, Knowles provides a comprehensive construction service, taking a project from concept to completion.",
      "It is our aim to exceed expectations at every point, regardless of the complexity of the project. This excellence is the foundation upon which Knowles is built.",
    ],
  },
];
...
export const newsItems = [
  {
    title:
      "PrimeResi: £23.5mn price tag for SHH-designed Little Venice villa",
    category: "Media",
    date: "May 2026",
  ...
  {
    title:
      "Project Announcement | Knowles Appointed on Phase 2, Continuing Works at Super Prime Residence in St John's Wood",
    category: "Projects",
    date: "March 2026",
